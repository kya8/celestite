...
{
    using clst::num_cast_ex, clst::NumCastRangeError;
    CLST_EXPECT_THROW(num_cast_ex<char>(CHAR_MAX + 1), NumCastRangeError);
    CLST_EXPECT_THROW(num_cast_ex<char>(CHAR_MIN - 1), NumCastRangeError);
    ...
    CLST_EXPECT_THROW(num_cast_ex<int>((unsigned int)(INT_MAX) + 1), NumCastRangeError);
    CLST_EXPECT_THROW(num_cast_ex<unsigned int>(-1), NumCastRangeError);
